...
SELECT * FROM gravity_books.dbo.cust_order co 
SELECT * FROM gravity_books.dbo.address a 
SELECT * FROM gravity_books.dbo.order_history oh 
SELECT * FROM gravity_books.dbo.order_line ol 
SELECT * FROM gravity_books.dbo.shipping_method sm 
SELECT * FROM gravity_books.dbo.order_status os 
