...
SELECT * FROM superhero.dbo.colour c ;
SELECT * FROM superhero.dbo.alignment a 
SELECT * FROM superhero.dbo.superhero s 
SELECT * FROM superhero.dbo.gender g 
SELECT * FROM superhero.dbo.superpower s2 
SELECT * FROM superhero.dbo.hero_power hp 
SELECT * FROM superhero.dbo.[attribute] a2 
SELECT * FROM superhero.dbo.hero_attribute ha 
